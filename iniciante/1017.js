...
let tViagemEmHoras = parseInt(lines.shift());
// para testar atribua o valor. Ex: 10
let vMediaEmKm =  parseInt(lines.shift());
// para testar atribua o valor. Ex: 85

let velPercorridaEmKm = vMediaEmKm * tViagemEmHoras;

let litrosCombustivel = velPercorridaEmKm/12;
